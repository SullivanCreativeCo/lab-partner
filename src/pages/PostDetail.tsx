...
import { ArrowLeft, TrendingUp, MessageSquare, Send, Trash2 } from "lucide-react";
    ...
    <CommunityLayout communityName="Creator Studio">
      <div className="px-4 py-4 space-y-4">
        ...
        >
          ...
          <div className="text-sm text-foreground/80 leading-relaxed whitespace-pre-line mb-4">
            {post.body}
          </div>
        ...
        <div className="rounded-xl border border-border bg-card p-3">
          ...
          <div className="flex justify-end mt-2">
            <Button size="sm" className="text-xs font-semibold gap-1.5" disabled={!comment.trim()}>
        ...
        <div className="space-y-2">
          ...
          {comments.map((c, i) => (
            ...
            >
              ...
              <button className="flex items-center gap-1 mt-2 text-[10px] text-muted-foreground hover:text-primary transition-colors">
